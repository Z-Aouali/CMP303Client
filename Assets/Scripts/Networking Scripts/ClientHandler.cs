...
public class ClientHandler : MonoBehaviour
{
    ...
    public static void PlayerPosition(Packet _packet)
    {
        ...
        GameManager.players[_id].Move(_tick,_position);
    }
    ...
    public static void Sync(Packet _packet)
    {
        Client.instance.SetTick(_packet.ReadInt());
    }
    ...
    public static void PlayerShot(Packet _packet)
    {
        ...
        GameManager.players[_fromPlayer].Shoot();
    }
}
